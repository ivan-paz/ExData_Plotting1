...
par(mfrow = c(2,2))
with (household_power_consumption_data ,plot(Date, Global_active_power, type = "l", ylab = "Global Active Power (Kilowatts)", xlab = ""))
with (household_power_consumption_data, plot(Date, Voltage, type = "l", ylab = "Voltage", xlab = "datetime"))
...
with (household_power_consumption_data, plot(Date, Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime"))
dev.off()